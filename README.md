...
- minecraft-admin-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- minecraft-admin-ui: main application module, development time
- minecraft-admin-production: module that produces a production mode WAR for deployment
